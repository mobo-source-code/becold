...
class Motor(models.Model):
    ...
    condensateur = models.CharField(max_length=125, verbose_name="Condensateur", null=True)
    i_max = models.CharField(max_length=125, verbose_name='Intensité max', null=True)
    type_de_ref = models.CharField(max_length=125, verbose_name='Type de Réfrigération', null=True)
